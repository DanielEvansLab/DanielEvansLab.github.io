...
## A. Collaboration and Open Access
...
hosted on GitHub. At a later stage, suitable cases will also be contributed 
to the Bioconductor project. The main 
source of documentation for both the users and developers are the vignettes and help files provided by the R packages
