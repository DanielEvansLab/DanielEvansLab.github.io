...
To maximize sharability and reproducibility of all data analysis results
generated by this project, most of its analysis routines will be implemented as R
...
these R packages (for an example see
...
Subsequently, open the vignette of the installed package in a browser, open it from withing RStudio or access
